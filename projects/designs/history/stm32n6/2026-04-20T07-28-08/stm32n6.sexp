(import stm32n657l0h3q
        ...
        abm8 fc-135 ecmf02-2amx6 usb4510-03-1-a-gct
...
(design-block "STM32N657L0H3Q Minimal Schematic"
  ...
  (section "User RGB LEDs" "2x APTF1616 RGB, common-anode, GPIO-driven (active-low)"
    ...
    (instance "LED1" (aptf1616lseezgkqbkc "APTF1616LSEEZGKQBKC")
      (pin 1 "VDD")
      (pin 2 "LED1_R_K")
      (pin 3 "LED1_G_K")
      (pin 4 "LED1_B_K") (id aa110010))
    (instance "LED2" (aptf1616lseezgkqbkc "RGB")
      (pin 1 "VDD")
      (pin 2 "LED2_R_K")
      (pin 3 "LED2_G_K")
  ...
  (section "Expansion Connector" "Molex SlimStack 204928-0301, 30-pin 0.4mm BTB"
    ...
    (note "Pins 11–30 unassigned — available for additional expansion I/O. MP1–MP4 board-lock tabs tied to GND."))
