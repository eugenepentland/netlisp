(import 204927-0601 pin-header-1x30)

;; Breakout board for the Cyclops Digital expansion connector.
;; J1 is the 204927-0601 SlimStack receptacle that mates with the
;; 204928-0601 expansion header on the Cyclops Digital board.
...
(design-block "Cyclops Expansion Breakout"
  ...
  (note "J1" "Molex SlimStack 204927-0601 — mates with the 204928-0601 expansion header on the Cyclops Digital board.")
