...
- **Project / introspection (read-only)**: `list_designs`, `list_library`,
  ...
  (the `/api/placement-spec` JSON; args: `name`, optional `layout`/`sub`/`regen`). `propose_placement`
