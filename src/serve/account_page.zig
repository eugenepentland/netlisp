...
fn currentEmail(ctx: *Server, req: *httpz.Request) ?[]const u8 {
...
pub fn accountPage(ctx: *Server, req: *httpz.Request, res: *httpz.Response) HandlerError!void {
...
pub fn createClientApi(ctx: *Server, req: *httpz.Request, res: *httpz.Response) HandlerError!void {
    const email = currentEmail(ctx, req) orelse {
        res.status = 401;
...
pub fn revokeClientApi(ctx: *Server, req: *httpz.Request, res: *httpz.Response) HandlerError!void {
    const email = currentEmail(ctx, req) orelse {
        res.status = 401;
        res.body = "sign in required";
        return;
...
pub fn manageRedirect(_: *Server, _: *httpz.Request, res: *httpz.Response) HandlerError!void {
    res.status = 303;
    res.header("location", "/account");
}

fn requireAdmin(ctx: *Server, req: *httpz.Request, res: *httpz.Response) ?[]const u8 {
    const email = currentEmail(ctx, req) orelse {
        res.status = 401;
        res.content_type = .JSON;
...
pub fn updateUserRoleApi(ctx: *Server, req: *httpz.Request, res: *httpz.Response) HandlerError!void {
...
/// the last admin.
pub fn deleteUserApi(ctx: *Server, req: *httpz.Request, res: *httpz.Response) HandlerError!void {
    const actor = requireAdmin(ctx, req, res) orelse return;
    const body = req.body() orelse {
        res.status = 400;
        res.body = err_missing_body;
