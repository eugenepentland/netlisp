...
pub fn jsApi(_: *Handler, _: *httpz.Request, res: *httpz.Response) HandlerError!void {
    res.content_type = .JS;
...
pub fn cssApi(_: *Handler, _: *httpz.Request, res: *httpz.Response) HandlerError!void {
